package net.daine.tutorialmod.entity.custom;
...
public class ChomperEntity extends Monster implements IAnimatable {
    ...
    public static AttributeSupplier setAttributes() { //used in ModEvent
    ...
    //type "override" to see a list of methods you can override
